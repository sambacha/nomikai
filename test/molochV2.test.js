  ...
  ([
    ...
    describe('submitWhitelistProposal', () => {
      ...
      it('happy case', async () => {
        ...
        await moloch.submitWhitelistProposal(newToken.address, 'whitelist me!', {
          from: proposal1.applicant,
        });
      ...
      it('require fail - applicant can not be zero', async () => {
        await moloch
          .submitWhitelistProposal(zeroAddress, 'whitelist me!', { from: proposal1.applicant })
      ...
      it('require fail - cannot add already have whitelisted the token', async () => {
        await moloch
          .submitWhitelistProposal(tokenAlpha.address, 'whitelist me!', {
            from: proposal1.applicant,
          })
          .should.be.rejectedWith(
            revertMessages.submitWhitelistProposalAlreadyHaveWhitelistedToken,
          );
      });
    ...
    describe('submitGuildKickProposal', () => {
      ...
      it('require fail - member must have at least one share', async () => {
        await moloch
          .submitGuildKickProposal(zeroAddress, 'kick me!', { from: proposal1.applicant })
          .should.be.rejectedWith(
            revertMessages.submitGuildKickProposalMemberMustHaveAtLeastOneShare,
          );
      });
    ...
    describe('sponsorProposal', () => {
      ...
      describe('with a second member besides the summoner', () => {
        ...
        it('failure - sponsor kick proposal already proposed', async () => {
          ...
          await moloch.submitGuildKickProposal(proposal1.applicant, 'kick', { from: proposer });
          ...
          await tokenAlpha.approve(moloch.address, deploymentConfig.PROPOSAL_DEPOSIT, {
            from: summoner,
          });
      ...
      it('failure - proposal has already been sponsored', async () => {
        ...
        await moloch
          .sponsorProposal(firstProposalIndex, { from: summoner })
      ...
      it('failure - proposal has been cancelled', async () => {
        ...
        // whitelist newToken
        await moloch.submitWhitelistProposal(newToken.address, 'whitelist me!', { from: proposer });
      ...
      it('failure - sponsor whitelist token proposal already proposed', async () => {
        ...
        await moloch
          .sponsorProposal(secondProposalIndex, { from: summoner })
      ...
      it('require fail - insufficient deposit token', async () => {
        ...
        // SafeMath reverts in ERC20.transferFrom
        await moloch
          .sponsorProposal(invalidPropsalIndex, { from: summoner })
          .should.be.rejectedWith(SolRevert);
      });
    ...
    describe('submitVote', () => {
      ...
      it('require fail - vote must be less than 3', async () => {
        await moloch
          .submitVote(firstProposalIndex, 3, { from: summoner })
      ...
      it('modifier - delegate', async () => {
        await moveForwardPeriods(1);
        await moloch
          .submitVote(firstProposalIndex, yes, { from: creator })
      ...
      describe('submitVote modifying member.highestIndexYesVote', () => {
        ...
        it('happy case - yes vote, highestIndexYesVote is updated', async () => {
          ...
          assert.equal(
            ...
            secondProposalIndex,
            'highestIndexYesVote does not match',
          );
        });
    ...
    describe('processProposal', () => {
      ...
      it('happy path - guild kick member', async () => {
        ...
        await moloch.submitGuildKickProposal(applicant, 'kick', { from: proposer });
        ...
        await verifyProcessProposal({
          ...
          expectedMaxSharesAndLootAtYesVote:
            proposal1.sharesRequested + summonerShares + proposal1.lootRequested,
        });
      ...
      it('edge case - dilution bound is exceeded', async () => {
        ...
        await verifyBalance({
          ...
          address: moloch.address,
          expectedBalance:
            deploymentConfig.PROPOSAL_DEPOSIT * 2 +
            proposal1.tributeOffered +
            proposal2.tributeOffered,
        });
      ...
      it('require fail - proposal does not exist', async () => {
        await moloch
          .processProposal(invalidPropsalIndex, { from: processor })
      ...
      it('require fail - proposal is not ready to be processed', async () => {
        ...
        await moloch
          .processProposal(firstProposalIndex, { from: processor })
      ...
      it('require fail - previous proposal must be processed', async () => {
        await tokenAlpha.transfer(proposal1.applicant, proposal1.tributeOffered * 2, {
          from: creator,
        });
        await tokenAlpha.approve(moloch.address, proposal1.tributeOffered * 2, {
          from: proposal1.applicant,
        });
        ...
        await tokenAlpha.transfer(summoner, deploymentConfig.PROPOSAL_DEPOSIT * 2, {
          from: creator,
        });
        await tokenAlpha.approve(moloch.address, deploymentConfig.PROPOSAL_DEPOSIT * 2, {
          from: summoner,
        });
        ...
        await moloch
          .processProposal(secondProposalIndex, { from: processor })
      ...
      it('require fail - must be a whitelist proposal', async () => {
        ...
        await moloch
          .processWhitelistProposal(firstProposalIndex, { from: applicant })
      ...
      it('require fail - must be a guild kick proposal', async () => {
        ...
        await moloch
          .processGuildKickProposal(firstProposalIndex, { from: applicant })
      ...
      it('require fail - must be a standard process not a guild kick proposal', async () => {
        ...
        await moloch
          .processProposal(firstProposalIndex, { from: applicant })
          .should.be.rejectedWith(revertMessages.processProposalMustBeAStandardProposal);
      });
    });
    ...
    describe('rageQuit + withdrawBalance', () => {
      ...
      describe('full ragequit - ', () => {
        ...
        beforeEach(async () => {
          const { logs } = await moloch.ragequit(
            proposal1.sharesRequested,
            proposal1.lootRequested,
            { from: proposal1.applicant },
          );
      ...
      describe('partial shares', () => {
        ...
        beforeEach(async () => {
          ...
          const { logs } = await moloch.ragequit(partialRageQuitShares, 0, {
            from: proposal1.applicant,
          });
          emittedLogs = logs;
        });
      ...
      describe('withdraw balance', async () => {
        ...
        it('withdraw full balance (applicant, sponsor, processor)', async () => {
          await moloch.withdrawBalance(depositToken.address, proposal1.tributeOffered - 1, {
            from: proposal1.applicant,
          });
          await moloch.withdrawBalance(
            depositToken.address,
            deploymentConfig.PROPOSAL_DEPOSIT - deploymentConfig.PROCESSING_REWARD,
            { from: summoner },
          );
          await moloch.withdrawBalance(depositToken.address, deploymentConfig.PROCESSING_REWARD, {
            from: processor,
          });
        ...
        it('require fail - insufficient balance', async () => {
          await moloch
            .withdrawBalance(depositToken.address, proposal1.tributeOffered, {
              from: proposal1.applicant,
            })
    ...
    describe('cancelProposal', () => {
      ...
      it('failure - already sponsored', async () => {
        ...
        await moloch
          .cancelProposal(firstProposalIndex, { from: proposal1.applicant })
      ...
      it('failure - solely the proposer can cancel', async () => {
        await moloch
          .cancelProposal(firstProposalIndex, { from: creator })
    ...
    describe('updateDelegateKey', () => {
      ...
      it('failure - cant overwrite existing members', async () => {
        ...
        await moloch
          .updateDelegateKey(applicant, { from: summoner })
      ...
      it('failure - cant overwrite existing delegate keys', async () => {
        ...
        await moloch
          .updateDelegateKey(processor, { from: summoner })
          .should.be.rejectedWith(
            revertMessages.updateDelegateKeyCantOverwriteExistingDelegateKeys,
          );
      });
    });
    ...
    describe('canRageQuit', () => {
      ...
      it('failure - proposal does not exist', async () => {
        await moloch
          .canRagequit(invalidPropsalIndex)
    ...
    describe('ragekick', () => {
      it('failure - member must be in jail', async () => {
        await moloch.ragekick(summoner).should.be.rejectedWith(revertMessages.ragekickMustBeInJail);
      });
    });
    ...
    describe('ragekick - member has never voted', () => {
      ...
      it('ragekick - happy case - can ragekick immediately after guild kick', async () => {
        ...
        const initialTotalSharesAndLoot = new BN(
          proposal1.lootRequested + proposal1.sharesRequested + 1,
        );
        const lootToRageQuit = new BN(proposal1.lootRequested + proposal1.sharesRequested); // ragequit 100% of loot + shares
        const tokensToRageQuit = initialGuildBankBalance
          .mul(lootToRageQuit)
          .div(initialTotalSharesAndLoot);
      ...
      it('happy case - can ragekick after second membership proposal is processed', async () => {
        ...
        await verifyInternalBalances({
          ...
          userBalances: {
            ...
            [proposal1.applicant]: proposal1.tributeOffered,
            [summoner]:
              (deploymentConfig.PROPOSAL_DEPOSIT - deploymentConfig.PROCESSING_REWARD) * 3,
    ...
    describe('getMemberProposalVote', () => {
      ...
      it('failure - member does not exist', async () => {
        await moloch
          .getMemberProposalVote(zeroAddress, firstProposalIndex)
          .should.be.rejectedWith(revertMessages.getMemberProposalVoteMemberDoesntExist);
      });

      it('failure - proposal does not exist', async () => {
        await moloch
          .getMemberProposalVote(summoner, invalidPropsalIndex)
    ...
    describe('as a member with solely loot and no shares...', () => {
      ...
      it('can still ragequit (justMember modifier)', async () => {
        ...
        await verifyBalances({
          token: depositToken,
          moloch: moloch.address,
          expectedMolochBalance: initialGuildBankBalance.add(
      ...
      it('can still partial ragequit (justMember modifier)', async () => {
        ...
        const tokensToRageQuit = initialGuildBankBalance
          .mul(lootToRageQuit)
          .div(initialTotalSharesAndLoot); // ragequit 1 less than total loot
      ...
      it('unable to update delegateKey (justShareholder modifier)', async () => {
        await moloch
          .updateDelegateKey(applicant2, { from: proposal1.applicant })
      ...
      it('unable to use delegate key to sponsor (justShareholder modifier)', async () => {
        ...
        await moloch
          .sponsorProposal(secondProposalIndex, { from: proposal1.applicant })
          .should.be.rejectedWith('not a delegate');
      ...
      it('unable to use delegate key to vote (justDelegate modifier)', async () => {
        ...
        await moloch
          .submitVote(secondProposalIndex, yes, { from: proposal1.applicant })
          .should.be.rejectedWith('not a delegate');
        ...
        await verifySubmitVote({
          ...
          expectedVote: yes,
          expectedMaxSharesAndLootAtYesVote:
            1 + proposal1.sharesRequested + proposal1.lootRequested,
        });
      });
    });
    ...
    describe('jail effects', () => {
      ...
      it('cant submit guild kick proposals for a jailed applicant', async () => {
        ...
        // try to submit second membership proposal - fails b/c jail
        await moloch
          .submitGuildKickProposal(applicant, 'kick', { from: proposer })
